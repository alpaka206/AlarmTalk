...
export const STOCK_CLIP_PRESETS = [
  ...
  // 안부 / 단호 / 공감 / 기대 / 아침 루틴 / 카운트다운 / 여유 / 다독임.
  // 광고 어휘('산뜻', '한결', '당신')·근거 없는 낙관 없이, 사람이 하는 입말로 쓴다.
  {
    category: 'morning',
    languages: ['ko', 'en', 'ja'],
    variants: [
      '좋은 아침이에요. 잘 잤어요? 기지개 한 번 켜고 천천히 일어나 봐요.',
      '일어날 시간이에요. 5분만 더는 오늘은 안 돼요. 자, 눈 떠 봐요.',
      '아직 눈 감고 있죠? 알아요, 지금 이불이 제일 포근하죠. 그래도 일어나야죠.',
      '굿모닝! 오늘 왠지 좋은 일 있을 것 같지 않아요? 일단 일어나서 확인해 봐요.',
      '창밖 좀 봐요, 벌써 환해요. 물 한 잔 마시면서 천천히 정신 차려 봐요.',
      '자, 셋 세면 일어나는 거예요. 하나, 둘, 셋! 지금이에요, 일어나요.',
      '급할 것 없어요. 천천히 일어나서 오늘 하루도 잘 보내 봐요.',
      '일어났어요? 크게 숨 한 번 쉬고요. 오늘 할 일은 하나씩 하면 다 돼요.',
    ],
  },
  {
    category: 'medication',
