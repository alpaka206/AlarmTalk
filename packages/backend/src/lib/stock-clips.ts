...
export const STOCK_CLIP_PRESETS = [
  ...
  // 기상 8문구 — 매일 순차 재생되므로 서로 뚜렷이 다른 컨셉을 유지한다:
  // 안부 / 공감→기대 / 몸 깨우기 코치 / 명랑 / 아침 루틴 / 카운트다운 / 여유 / 심호흡·응원.
  {
    category: 'morning',
    languages: ['ko', 'en', 'ja'],
    variants: [
      '좋은 아침이에요. 잘 잤어요? 기지개 한 번 켜고, 오늘 하루도 산뜻하게 시작해 봐요.',
      '아침이 왔어요. 이불이 아무리 포근해도, 오늘의 좋은 일들이 밖에서 기다리고 있어요.',
      '일어날 시간이에요. 발끝부터 천천히 움직여 볼까요? 몸이 금방 깨어날 거예요.',
      '굿모닝! 오늘은 어제보다 조금 더 좋은 일이 생길 거예요. 웃으면서 시작해요.',
      '창밖이 벌써 환해요. 일어나서 물 한 잔 마시면, 하루가 한결 가볍게 열릴 거예요.',
      '자, 이제 진짜 일어날 시간이에요. 셋 셀게요. 하나, 둘, 셋! 몸을 일으켜 봐요.',
      '오늘도 당신의 아침이 왔어요. 서두르지 않아도 괜찮으니, 천천히 하루를 열어 봐요.',
      '눈 떴어요? 심호흡 한 번 크게 하고요. 오늘 하루, 분명 잘 풀릴 거예요.',
    ],
  },
  {
    category: 'medication',
    ...
    variants: [
      ...
      '잠깐만요, 약 챙길 시간이에요. 지금 바로 드시면 오늘도 든든해요.',
    ],
  },
  {
