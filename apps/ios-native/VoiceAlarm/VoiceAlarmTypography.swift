...
/// `apps/android-native/.../ui/theme/VoiceAlarmTypography.kt:16-33`.
///
...
extension VoiceAlarmTypography {
    ...
    static let `default` = VoiceAlarmTypography(
