...
/// `@Environment(\.voiceAlarmTheme)` defined in `VoiceAlarmTheme.swift`.
///
/// Color values are sourced from the Android light palette in
/// `apps/android-native/app/src/main/java/com/voicealarm/nativeapp/ui/theme/VoiceAlarmTheme.kt:60-85`.
enum VoiceAlarmTheme {
    // Brand / primary
