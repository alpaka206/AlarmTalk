...
struct AlarmLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: AlarmAttributes<VoiceAlarmMetadata>.self) { context in
            content(for: context)
                .padding(16)
    ...
    @ViewBuilder
    private func content(for context: ActivityViewContext<AlarmAttributes<VoiceAlarmMetadata>>) -> some View {
