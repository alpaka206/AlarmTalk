...
- 브랜치: develop_loop
- 마지막 루프: 2026-04-25 — P97 billing.ts 분할
- 현재 Phase: **R0~R6 전체 완료 + P11~P97 완료**
...
- **P11~P96**: 전체 완료
- **P97**: billing.ts 378줄 → billing-helpers.ts(23줄) + billing-query.ts(90줄) + billing-mutation.ts(230줄) + billing.ts(10줄 aggregator) 분할
