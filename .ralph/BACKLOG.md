...
- [x] peopleScreen + alarmCreateScreen 비즈니스 로직 테스트 110개: peopleScreen(62, avatarInitial/buildSegments/defaultSegment/sortMembersOwnerFirst/filterPendingInvites/isCouple/badgeText/friendDisplayLabel) + alarmCreateScreen(48, quickSetDays/toggleDay/soundOnlyInvalid/amPm/formatTimeString/hourUp-Down/minuteUp-Down/filterReadyVoices/isSubmitDisabled/extractFriendId/findCachedMessage) (P147)
- [x] libraryScreen + playerScreen + voiceRecordScreen 비즈니스 로직 테스트 165개: libraryScreen(55, CATEGORIES/getCategoryLabel/filterByCategory/sortItems/computeDisplayItems/isShowingCached/emptyState/queryConfig) + playerScreen(72, generateWaveform/formatTime/getBackgroundColor/getEmoji/seekClamp/seekProgress/processPlaybackStatus/computeActiveBarIndex/isNearPlayhead/stateTransitions/params) + voiceRecordScreen(38, dbToNormalized/formatRecordTime/validateSubmit/updateLevelHistory/initLevelHistory/computeBarHeight/computeBarColor/stateMachine/permissions) (P148)
- [x] alarmEditScreen + messageCreateScreen + friendProfileScreen 비즈니스 로직 테스트 146개: alarmEditScreen(55, parseAlarmTime/parseAlarmToState/quickSetDays/toggleDay/computeSoundOnlyInvalid/formatTime/computeAmPm/buildSubmitPayload/filterReadyVoices/isSubmitDisabled/roundtrip) + messageCreateScreen(56, filterReadyProfiles/deriveMessageText/validateGenerate/buildTTSPayload/isGenerateDisabled/enforceCustomTextLimit/getAvatarInitial/findCategoryByKey/giftRecipientHelpers/buildGiftPayload/tabSwitching/playbackToggle/voiceIdParam/friendsListGuard) + friendProfileScreen(35, findFriendById/computeFriendName/computeInitial/filterGiftsToFriend/filterGiftsFromFriend/filterAlarmsForFriend/statusText/sliceRecent/formatSinceDate/combinedFlow) (P149)
- [x] onboarding/noteCreate/noteDetail/giftReceived/messageDetail 스크린 비즈니스 로직 테스트 130개: onboardingScreen(38, pageNav/isLastPage/getNextIndex/buttonLabel/pageEmoji/pageBgColor/scrollIndex/dotWidth/dotOpacity) + noteCreateScreen(30, filterRecipients/canSend/textValidation/displayName/initial/queryEnable/charCount) + noteDetailScreen(22, findNote/senderDisplay/senderInitial/markAsRead/hasAudio/formatDate) + giftReceivedScreen(24, statusLabel/isPending/isAccepted/showActions/showSetAlarm/hasNote/senderDisplay/optimisticUpdates/countByStatus) + messageDetailScreen(16, findMessage/hasVoice/voiceInitial/categoryDisplay/cacheButtons/routeBuilders/playbackLabel) (P150)
