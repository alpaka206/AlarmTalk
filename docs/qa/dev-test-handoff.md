...
컴파일에서 멈췄다. 함수와 콜백의 격리를 모두 명시했다. 이번 CI 실패 복구 요청에 따라
iOS 자동 검증을 실행하며, 결과는 [리뷰 대응 기록](pr-730-post-merge-reviews-2026-09-13.md)의
「#737 CI 실패 복구」에 기록한다. 일반 리뷰 수정의 실행 제한을 바꾼 것은 아니다.
