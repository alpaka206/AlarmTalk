...
- [ ] 사업자: 유료 앱 계약·법인/한국 규정 정보·세금/은행 입력, 공개 국가 선택
- [ ] 심사 연락처·테스트 계정·콘텐츠 권리·App Privacy 최종 확인
- [ ] Google Play 25 production 초안을 실제 게재한 뒤 최신 서버를 main으로 배포
- [ ] Apple에서 처리 완료된 빌드 연결, TestFlight 구매·복원·APNs·실기기 알람 검증
- [ ] #730 최신 같은 상품 복구 P2 수정 PR 머지 후 원본 지적 해결 확인
